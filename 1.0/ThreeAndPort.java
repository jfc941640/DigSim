...
//
// ---- Description ----
// Java class containing methods for a 3-input AND port
//
...
class ThreeAndPort extends AndPort {

//----------------------------------------------------------------------------
// The constructor of a 3-input AND port
//----------------------------------------------------------------------------
    public ThreeAndPort(Pin PinGrid[][], int x, int y) {
        super(3, x, y, ComponentPin.PIN_TEXT_INVISIBLE);
        ComponentName = "3-input AND port";
...
//----------------------------------------------------------------------------
// The constructor of a new 3-input AND port, which is a copy of CompToCopy
//----------------------------------------------------------------------------
    public ThreeAndPort (ElectronicComponent CompToCopy, int xo, int yo) {
...
//----------------------------------------------------------------------------
    public ElectronicComponent Copy(int xo, int yo) {
        ThreeAndPort NewComponent = new ThreeAndPort(this, xo, yo);
        return NewComponent;
    }
}