...
//
// ---- Description ----
// Java class containing methods for a Exclusive or-port
//
...
class XorPort extends LogicPort {

//----------------------------------------------------------------------------
// The constructor of a new Xor port
//----------------------------------------------------------------------------
    public XorPort(int i, int x, int y, int fl) {
        super(i, x, y, fl);
    }

//----------------------------------------------------------------------------
// The constructor of a new XOR port, which is a copy of CompToCopy
//----------------------------------------------------------------------------
    public XorPort (ElectronicComponent CompToCopy, int xo, int yo) {
...
//----------------------------------------------------------------------------
// Method for drawing this XOR port
//----------------------------------------------------------------------------
    public void draw(Graphics g, int xp, int yp, int gs) {
        ...
        g.drawArc ((int)((x + 1.5) * gs), (y + 1) * gs, gs * 1, gs * 4 , -90, 180);
    }
