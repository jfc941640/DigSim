...
//
// ---- Description ----
// Java class containing methods for a 2-input exclusive OR port
//
...
class TwoXorPort extends XorPort {

//----------------------------------------------------------------------------
// The constructor of a 2-input XOR port
//----------------------------------------------------------------------------
    public TwoXorPort(Pin PinGrid[][], int x, int y) {
        super(2, x, y, ComponentPin.PIN_TEXT_INVISIBLE);                        // Construct input pins;
        ComponentName = "2-input XOR port";
...
//----------------------------------------------------------------------------
// The constructor of a new 2-input XOR port, which is a copy of CompToCopy
//----------------------------------------------------------------------------
    public TwoXorPort (ElectronicComponent CompToCopy, int xo, int yo) {
...
//----------------------------------------------------------------------------
    public ElectronicComponent Copy(int xo, int yo) {
        TwoXorPort NewComponent = new TwoXorPort(this, xo, yo);
        return NewComponent;
    }
}