...
//
// ---- Description ----
// Java class containing methods for a 3-input NAND port
//
...
class ThreeNandPort extends AndPort {

//----------------------------------------------------------------------------
// The constructor of a 3-input NAND port
//----------------------------------------------------------------------------
    public ThreeNandPort(Pin PinGrid[][], int x, int y) {
        super(3, x, y, ComponentPin.PIN_TEXT_INVISIBLE | ComponentPin.PIN_NEGATIVE);
        ComponentName = "3-input NAND port";
...
//----------------------------------------------------------------------------
// The constructor of a new 3-input NAND port, which is a copy of CompToCopy
//----------------------------------------------------------------------------
    public ThreeNandPort (ElectronicComponent CompToCopy, int xo, int yo) {
...
//----------------------------------------------------------------------------
    public ElectronicComponent Copy(int xo, int yo) {
        ThreeNandPort NewComponent = new ThreeNandPort(this, xo, yo);
        return NewComponent;
    }
}