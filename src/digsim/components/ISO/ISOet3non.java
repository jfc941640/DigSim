...
public class ISOet3non extends ElectronicComponent
{

    public ISOet3non(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "ET3-NON";
        ClassName = "ISOet3non";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public ISOet3non(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        ISOet3non isoet3non = new ISOet3non(this, i, j);
        return isoet3non;
    }
