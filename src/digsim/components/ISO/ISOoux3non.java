...
public class ISOoux3non extends ElectronicComponent
{

    public ISOoux3non(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "OUX3-NON";
        ClassName = "ISOoux3non";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public ISOoux3non(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        ISOoux3non isooux3non = new ISOoux3non(this, i, j);
        return isooux3non;
    }
