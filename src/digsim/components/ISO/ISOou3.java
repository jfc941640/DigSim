...
public class ISOou3 extends ElectronicComponent
{

    public ISOou3(Pin apin[][], int i, int j)
    {
    ...
    public ISOou3(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        ISOou3 isoou3 = new ISOou3(this, i, j);
        return isoou3;
    }
