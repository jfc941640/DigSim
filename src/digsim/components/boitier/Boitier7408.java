...
public class Boitier7408 extends IntegratedCircuit
{

    public Boitier7408(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "74HC08";
        ClassName = "Boitier7408";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public Boitier7408(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Boitier7408 boitier7408 = new Boitier7408(this, i, j);
        return boitier7408;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        DrawWithOffset.fillText(g,"74HC08", (l + 5) * k, (i1 + 3) * k);
        DrawWithOffset.fillText(g,"4ET2", (l + 5) * k + 3, (i1 + 4) * k);
