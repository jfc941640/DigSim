...
public class Boitier7486 extends IntegratedCircuit
{

    public Boitier7486(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "74HC86";
        ClassName = "Boitier7486";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public Boitier7486(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Boitier7486 boitier7486 = new Boitier7486(this, i, j);
        return boitier7486;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        DrawWithOffset.fillText(g,"74HC86", (l + 5) * k, (i1 + 3) * k);
        DrawWithOffset.fillText(g,"4XOR2", (l + 5) * k + 1, (i1 + 4) * k);
