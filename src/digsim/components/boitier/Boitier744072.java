...
public class Boitier744072 extends IntegratedCircuit
{

    public Boitier744072(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "74HC4072";
        ClassName = "Boitier744072";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public Boitier744072(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Boitier744072 boitier744072 = new Boitier744072(this, i, j);
        return boitier744072;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        DrawWithOffset.fillText(g,"74HC4072", (l + 4) * k + 5, (i1 + 3) * k);
        DrawWithOffset.fillText(g,"2OU4", (l + 5) * k + 5, (i1 + 4) * k);
