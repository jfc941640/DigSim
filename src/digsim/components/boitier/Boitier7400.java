...
public class Boitier7400 extends IntegratedCircuit
{

    public Boitier7400(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "74HC00";
        ClassName = "Boitier7400";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public Boitier7400(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Boitier7400 boitier7400 = new Boitier7400(this, i, j);
        return boitier7400;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        DrawWithOffset.fillText(g,"74HC00", (l + 5) * k, (i1 + 3) * k);
        DrawWithOffset.fillText(g,"4NAND2", (l + 5) * k - 3, (i1 + 4) * k);
