...
public class Boitier7411 extends IntegratedCircuit
{

    public Boitier7411(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "74HC11";
        ClassName = "Boitier7411";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public Boitier7411(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Boitier7411 boitier7411 = new Boitier7411(this, i, j);
        return boitier7411;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        DrawWithOffset.fillText(g,"74HC11", (l + 5) * k, (i1 + 3) * k);
        DrawWithOffset.fillText(g,"3ET3", (l + 5) * k + 3, (i1 + 4) * k);
