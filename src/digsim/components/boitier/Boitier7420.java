...
public class Boitier7420 extends IntegratedCircuit
{

    public Boitier7420(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "74HC20";
        ClassName = "Boitier7420";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public Boitier7420(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Boitier7420 boitier7420 = new Boitier7420(this, i, j);
        return boitier7420;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        DrawWithOffset.fillText(g,"74HC20", (l + 5) * k, (i1 + 3) * k);
        DrawWithOffset.fillText(g,"2NAND4", (l + 5) * k - 3, (i1 + 4) * k);
