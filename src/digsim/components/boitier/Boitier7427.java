...
public class Boitier7427 extends IntegratedCircuit
{

    public Boitier7427(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "74HC27";
        ClassName = "Boitier7427";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public Boitier7427(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Boitier7427 boitier7427 = new Boitier7427(this, i, j);
        return boitier7427;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        DrawWithOffset.fillText(g,"74HC27", (l + 5) * k, (i1 + 3) * k);
        DrawWithOffset.fillText(g,"3NOR3", (l + 5) * k, (i1 + 4) * k);
