...
public class FourBitBinaryUpDownCounter extends IntegratedCircuit
{

    public FourBitBinaryUpDownCounter(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "CtrDctr Bin 4bits chargement async a 0 ou 15";
        ClassName = "FourBitBinaryUpDownCounter";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public FourBitBinaryUpDownCounter(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        FourBitBinaryUpDownCounter fourbitbinaryupdowncounter = new FourBitBinaryUpDownCounter(this, i, j);
        return fourbitbinaryupdowncounter;
    }
