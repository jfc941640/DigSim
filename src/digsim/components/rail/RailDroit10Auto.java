...
public class RailDroit10Auto extends ElectronicComponent
{

    public RailDroit10Auto(Pin apin[][], int i, int j)
    {
        ...
        ClassName = "RailDroit10Auto";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public RailDroit10Auto(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        RailDroit10Auto raildroit10auto = new RailDroit10Auto(this, i, j);
        return raildroit10auto;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        if(IPin[0].PinDim.width > 0)
        {
            ...
            DrawWithOffset.fillText(g,"...", (l + 5) * k - 4, (i1 + 1) * k + 5);
        } else
        ...
        if(IPin[0].PinDim.width < 0)
        {
            ...
            DrawWithOffset.fillText(g,"....", (l + 5) * k - 5, (i1 + 1) * k + 5);
        } else
        if(IPin[0].PinDim.height < 0)
        {
            Rapide = true;
            ...
            DrawWithOffset.fillText(g,":", (l + 1) * k + 3, (i1 + 5) * k + 2);
            DrawWithOffset.fillText(g,":", (l + 1) * k + 3, (i1 + 5) * k + 4);
        }
    }
