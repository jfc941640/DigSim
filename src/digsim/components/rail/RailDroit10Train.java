...
public class RailDroit10Train extends ElectronicComponent
{

    public RailDroit10Train(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "Rail droit ''10'' avec ''loco''";
        ClassName = "RailDroit10Train";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public RailDroit10Train(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        RailDroit10Train raildroit10train = new RailDroit10Train(this, i, j);
        return raildroit10train;
    }
