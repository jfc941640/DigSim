...
public class RailKlaxon extends ElectronicComponent
{

    public RailKlaxon(Pin apin[][], int i, int j)
    {
        super(i, j, 0, 0, 1, 1, 0, 0, 1, 0);
        OUT = false;
        oldOUT = false;
        ComponentName = "Klaxon";
        ClassName = "RailKlaxon";
        Can_Rotate = true;
    ...
    public RailKlaxon(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        RailKlaxon railklaxon = new RailKlaxon(this, i, j);
        return railklaxon;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        DrawWithOffset.fillText(g,"k", (l + 1) * k - 2, (i1 + 1) * k + 3);
        g.setStroke(MyColor.black);
        DrawWithOffset.strokeRect(g,l * k + 4, i1 * k + 4, k, k);
        DrawWithOffset.fillText(g,".", (l + 1) * k - 3, i1 * k + 5);
        g.setFill(MyColor.gray);
        DrawWithOffset.fillText(g,".", (l + 1) * k - 3, i1 * k + 6);
    }
