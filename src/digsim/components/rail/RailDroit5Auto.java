...
public class RailDroit5Auto extends ElectronicComponent
{

    public RailDroit5Auto(Pin apin[][], int i, int j)
    {
        ...
        OPin[0] = new OutputPin("", 5, 1, -1, 0, 0, 0, 0);
        OPin[1] = new OutputPin("", 0, 2, 1, 0, 0, 0, 0);
        ComposantFont = Font.font("Sans-serif", 10);
        ComponentName = "Rail droit ''5'' auto";
        ClassName = "RailDroit5Auto";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public RailDroit5Auto(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        RailDroit5Auto raildroit5auto = new RailDroit5Auto(this, i, j);
        return raildroit5auto;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        if(IPin[0].PinDim.width > 0)
        {
            ...
            for(int j1 = 1; j1 < 3; j1++)
                DrawWithOffset.fillRect(g,l * k + 7 * j1 + 8, i1 * k + 5, 0 * k + 4, 2 * k - 1);
        ...
        if(IPin[0].PinDim.height > 0)
        {
            ...
            for(int l1 = 1; l1 < 3; l1++)
                DrawWithOffset.fillRect(g,l * k + 5, i1 * k + 7 * l1 + 8, 2 * k - 1, 0 * k + 4);
        ...
        if(IPin[0].PinDim.width < 0)
        {
            ...
            for(int j2 = 1; j2 < 3; j2++)
                DrawWithOffset.fillRect(g,l * k + 7 * j2 + 8, i1 * k + 5, 0 * k + 4, 2 * k - 1);
        ...
        if(IPin[0].PinDim.height < 0)
        {
            ...
            for(int l2 = 1; l2 < 3; l2++)
                DrawWithOffset.fillRect(g,l * k + 5, i1 * k + 7 * l2 + 8, 2 * k - 1, 0 * k + 4);
