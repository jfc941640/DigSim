...
public class RailDroit10 extends ElectronicComponent
{

    public RailDroit10(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "Rail droit ''10''";
        ClassName = "RailDroit10";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public RailDroit10(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        RailDroit10 raildroit10 = new RailDroit10(this, i, j);
        return raildroit10;
    }
