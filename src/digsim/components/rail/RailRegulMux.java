...
public class RailRegulMux extends IntegratedCircuit
{

    public RailRegulMux(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "Module pour gestion bidirectionnelle";
        ClassName = "RailRegulMux";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public RailRegulMux(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        RailRegulMux railregulmux = new RailRegulMux(this, i, j);
        return railregulmux;
    }
