...
public class RailAiguillageDroit10Com extends ElectronicComponent
{

    public RailAiguillageDroit10Com(Pin apin[][], int i, int j)
    {
        ...
        IPin[2] = new InputPin("", 9, 5, 0, -1, 0, 0, 0);
        IPin[3] = new InputPin("", 8, 6, 0, -2, 0, 0, 0);
        IPin[4] = new InputPin("", 6, 6, 0, -2, 0, 0, 1);
        IPin[5] = new InputPin("", 0, 1, 1, 0, 0, 0, 0);
        ...
        if(AIG == 5)
            Aiguill = true;
        ComponentName = "Aiguillage ''10'' D";
        ClassName = "RailAiguillageDroit10Com";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public RailAiguillageDroit10Com(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        RailAiguillageDroit10Com railaiguillagedroit10com = new RailAiguillageDroit10Com(this, i, j);
        return railaiguillagedroit10com;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        if(IPin[0].PinDim.width > 0)
        {
            ...
            DrawWithOffset.strokeLine(g,(l + 9) * k, (i1 + 4) * k, (l + 9) * k, (i1 + 3) * k);
            DrawWithOffset.strokeLine(g,(l + 8) * k - 1, (i1 + 4) * k, (l + 8) * k - 1, (i1 + 6) * k);
            if(!Aiguill)
            {
        ...
        if(IPin[0].PinDim.height > 0)
        {
            ...
            DrawWithOffset.strokeLine(g,(l + 1) * k, (i1 + 9) * k, (l + 2) * k, (i1 + 9) * k);
            DrawWithOffset.strokeLine(g,(l - 1) * k, (i1 + 8) * k + 1, (l + 1) * k, (i1 + 8) * k + 1);
            if(!Aiguill)
            {
        ...
        if(IPin[0].PinDim.width < 0)
        {
            ...
            DrawWithOffset.strokeLine(g,(l + 1) * k, (i1 + 2) * k, (l + 1) * k, (i1 + 1) * k);
            DrawWithOffset.strokeLine(g,(l + 2) * k + 1, (i1 - 1) * k, (l + 2) * k + 1, (i1 + 1) * k);
            if(!Aiguill)
            {
        ...
        if(IPin[0].PinDim.height < 0)
        {
            ...
            DrawWithOffset.strokeLine(g,(l + 4) * k, (i1 + 1) * k, (l + 3) * k, (i1 + 1) * k);
            DrawWithOffset.strokeLine(g,(l + 4) * k, (i1 + 2) * k + 1, (l + 6) * k, (i1 + 2) * k + 1);
            if(!Aiguill)
            {
