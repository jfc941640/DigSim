...
public class RailMasque1 extends ElectronicComponent
{

    public RailMasque1(Pin apin[][], int i, int j)
    {
        super(i, j, 6, 6, 0, 0, 5, 5, 1, 0);
        IPin[0] = new InputPin("", 0, 0, 1, 0, 0, 0, 0);
        ComponentName = "Masque gris";
        ClassName = "RailMasque1";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public RailMasque1(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        RailMasque1 railmasque1 = new RailMasque1(this, i, j);
        return railmasque1;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        int l = Pos.x - i;
        int i1 = Pos.y - j;
        g.setStroke(Color.rgb(128, 128, 128));
