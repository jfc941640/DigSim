...
public class RailButoir extends ElectronicComponent
{

    public RailButoir(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "Rail butoir ''10''";
        ClassName = "RailButoir";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public RailButoir(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        RailButoir railbutoir = new RailButoir(this, i, j);
        return railbutoir;
    }
