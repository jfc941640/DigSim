...
public class RailSegmentH extends ElectronicComponent
{

    public RailSegmentH(Pin apin[][], int i, int j)
    {
        ...
        Vitesse = 0;
        NbrW = 3;
        IPin[0] = new InputPin("", 0, 1, 0, 0, 0, 0, 0);
        IPin[1] = new InputPin("", 1, 2, 0, 0, 0, 0, 0);
        IPin[2] = new InputPin("", -1, 3, 1, 0, 0, 0, 0);
        OPin[0] = new OutputPin("", 1, 1, 0, 0, 0, 0, 0);
        OPin[1] = new OutputPin("", 0, 2, 0, 0, 0, 0, 0);
        ComposantFont = Font.font("Sans-serif", 10);
        ComponentName = "Segment de rail H";
        ClassName = "RailSegmentH";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public RailSegmentH(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        RailSegmentH railsegmenth = new RailSegmentH(this, i, j);
        return railsegmenth;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        DrawWithOffset.fillRect(g,l * k, (i1 + 1) * k - 1, 1 * k + 1, 0 * k + 3);
        DrawWithOffset.fillRect(g,l * k, (i1 + 2) * k - 1, 1 * k + 1, 0 * k + 3);
        DrawWithOffset.strokeLine(g,(l + 1) * k, (i1 + 1) * k, (l + 1) * k, (i1 + 1) * k - 2);
        ...
        if(Train && (!Horaire || Count != lngr) && (Horaire || Count != -lngr))
        {
            ...
            {
                g.setFill(MyColor.black);
                DrawWithOffset.fillOval(g,((l + 4) * k - 36) + Count / 10 + 3 * j1, i1 * k + 5, 2 * k, 2 * k);
            }
        ...
        {
            Vitesse = 80;
            DrawWithOffset.fillText(g,"....", l * k - 1, (i1 + 1) * k + 5);
        }
    }
