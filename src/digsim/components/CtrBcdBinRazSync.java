...
public class CtrBcdBinRazSync extends IntegratedCircuit
{

    public CtrBcdBinRazSync(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "CtrDctr BIN-DCB 4bits prog -CTR-PIPO- RAZ sync";
        ClassName = "CtrBcdBinRazSync";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public CtrBcdBinRazSync(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        CtrBcdBinRazSync ctrbcdbinrazsync = new CtrBcdBinRazSync(this, i, j);
        return ctrbcdbinrazsync;
    }
