...
public class ESSAICOMPOSANT8 extends IntegratedCircuit
{

    public ESSAICOMPOSANT8(Pin apin[][], int i, int j)
    {
        ...
        ClassName = "ESSAICOMPOSANT8";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public ESSAICOMPOSANT8(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        ESSAICOMPOSANT8 essaicomposant8 = new ESSAICOMPOSANT8(this, i, j);
        return essaicomposant8;
    }
