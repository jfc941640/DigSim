...
public class Counterxx161 extends IntegratedCircuit
{

    public Counterxx161(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "Ctr BIN 4bits prog -CTR-PIPO- RAZ async (74HC161)";
        ClassName = "Counterxx161";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public Counterxx161(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Counterxx161 counterxx161 = new Counterxx161(this, i, j);
        return counterxx161;
    }
