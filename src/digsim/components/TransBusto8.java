...
public class TransBusto8 extends IntegratedCircuit
{

    public TransBusto8(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "Decompacteur de bus unidirectionnel 8 bits";
        ClassName = "TransBusto8";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public TransBusto8(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        TransBusto8 transbusto8 = new TransBusto8(this, i, j);
        return transbusto8;
    }

    public void SimulateLogic()
    {
        if(IPin[0].getLevel() == 0x6ca47)
        {
            HighZ = true;
            ...
            OPin[4].setLevel(0x6c9d8);
            OPin[5].setLevel(0x6c9d8);
            OPin[6].setLevel(0x6c9d8);
            OPin[7].setLevel(0x6c9d8);
        } else
        {
            HighZ = false;
