...
public class Oscillateur100ms extends ElectronicComponent
{

    public Oscillateur100ms(Pin apin[][], int i, int j)
    {
        super(i, j, 8, 6, 1, 1, 4, 4, 0, 1);
        ComponentName = "Horloge 100ms";
        ClassName = "Oscillateur100ms";
        Can_Rotate = true;
    ...
    public Oscillateur100ms(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Oscillateur100ms oscillateur100ms = new Oscillateur100ms(this, i, j);
        return oscillateur100ms;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        Temps = Math.round((int)(Millis / 50D)) % 2;
        g.setFill(MyColor.black);
        DrawWithOffset.fillText(g,"100 ms", (l + 2) * k - 6, (i1 + 3) * k + 5);
    }
