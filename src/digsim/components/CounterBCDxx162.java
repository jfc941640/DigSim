...
public class CounterBCDxx162 extends IntegratedCircuit
{

    public CounterBCDxx162(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "Ctr DCB 4bits prog -CTR-PIPO- RAZ sync (74HC162)";
        ClassName = "CounterBCDxx162";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public CounterBCDxx162(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        CounterBCDxx162 counterbcdxx162 = new CounterBCDxx162(this, i, j);
        return counterbcdxx162;
    }
