...
public class Encodeur8vers3 extends IntegratedCircuit
{

    public Encodeur8vers3(Pin apin[][], int i, int j)
    {
        ...
        ClassName = "Encodeur8vers3";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public Encodeur8vers3(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Encodeur8vers3 encodeur8vers3 = new Encodeur8vers3(this, i, j);
        return encodeur8vers3;
    }
