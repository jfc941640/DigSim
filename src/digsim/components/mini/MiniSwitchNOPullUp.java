...
public class MiniSwitchNOPullUp extends ElectronicComponent
{

    public MiniSwitchNOPullUp(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "Contact NO (T) avec resistance de pull-up";
        ClassName = "MiniSwitchNOPullUp";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public MiniSwitchNOPullUp(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        MiniSwitchNOPullUp miniswitchnopullup = new MiniSwitchNOPullUp(this, i, j);
        return miniswitchnopullup;
    }
