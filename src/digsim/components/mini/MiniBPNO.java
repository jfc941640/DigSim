...
public class MiniBPNO extends ElectronicComponent
{

    public MiniBPNO(Pin apin[][], int i, int j)
    {
        super(i, j, 10, 5, 2, 1, 2, 2, 0, 0);
        MiniBPNOClosed = true;
        ALevel = -1;
        QLevel = -1;
        ComponentName = "BP NO (normalement ouvert - contact T)";
        ClassName = "MiniBPNO";
        Can_Rotate = true;
        APos = new Point(1, 1);
        QPos = new Point(5, 1);
    ...
    public MiniBPNO(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        MiniBPNO minibpno = new MiniBPNO(this, i, j);
        minibpno.NbRotation = NbRotation;
        minibpno.updatePinsPosition();
        return minibpno;
    }

    public boolean SimMouseDown()
    {
        MiniBPNOClosed = false;
        return true;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        if(NbRotation == 0)
        {
            ...
            if(MiniBPNOClosed)
            {
                DrawWithOffset.strokeLine(g,(l + 3) * k, (i1 + 2) * k - 4, (l + 3) * k, (i1 + 3) * k);
            ...
            {
                DrawWithOffset.strokeLine(g,(l + 3) * k, (i1 + 1) * k, (l + 3) * k, (i1 + 3) * k - 4);
            ...
            if(MiniBPNOClosed)
            {
                DrawWithOffset.strokeLine(g,(l + 2) * k, (i1 + 2) * k - 1, (l + 4) * k, (i1 + 1) * k - 1);
                DrawWithOffset.strokeLine(g,(l + 2) * k, (i1 + 2) * k, (l + 4) * k, (i1 + 1) * k);
            } else
            {
                DrawWithOffset.strokeLine(g,(l + 2) * k, (i1 + 1) * k - 1, (l + 4) * k, (i1 + 1) * k - 1);
                DrawWithOffset.strokeLine(g,(l + 2) * k, (i1 + 1) * k, (l + 4) * k, (i1 + 1) * k);
            }
        } else
        if(NbRotation == 1)
        {
            ...
            if(MiniBPNOClosed)
            {
                DrawWithOffset.strokeLine(g,(l + 2) * k, (i1 + 2) * k, (l + 4) * k - 4, (i1 + 2) * k);
            ...
            {
                DrawWithOffset.strokeLine(g,(l + 3) * k - 4, (i1 + 2) * k, (l + 4) * k, (i1 + 2) * k);
            ...
            if(MiniBPNOClosed)
            {
                DrawWithOffset.strokeLine(g,(l + 3) * k - 1, (i1 + 1) * k, (l + 4) * k - 1, (i1 + 3) * k);
                DrawWithOffset.strokeLine(g,(l + 3) * k, (i1 + 1) * k, (l + 4) * k, (i1 + 3) * k);
            } else
            {
                DrawWithOffset.strokeLine(g,(l + 4) * k - 1, (i1 + 1) * k, (l + 4) * k - 1, (i1 + 3) * k);
                DrawWithOffset.strokeLine(g,(l + 4) * k, (i1 + 1) * k, (l + 4) * k, (i1 + 3) * k);
            }
        }
    }
