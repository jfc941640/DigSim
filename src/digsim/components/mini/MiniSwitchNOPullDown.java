...
public class MiniSwitchNOPullDown extends ElectronicComponent
{

    public MiniSwitchNOPullDown(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "Contact NO (T) avec resistance de pull-down";
        ClassName = "MiniSwitchNOPullDown";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public MiniSwitchNOPullDown(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        MiniSwitchNOPullDown miniswitchnopulldown = new MiniSwitchNOPullDown(this, i, j);
        return miniswitchnopulldown;
    }
