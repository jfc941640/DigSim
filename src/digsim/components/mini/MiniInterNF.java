...
public class MiniInterNF extends ElectronicComponent
{

    public MiniInterNF(Pin apin[][], int i, int j)
    {
        super(i, j, 10, 5, 2, 1, 2, 2, 0, 0);
        MiniInterNFClosed = true;
        ALevel = -1;
        QLevel = -1;
        ComponentName = "Inter NF (normalement ferme - contact R)";
        ClassName = "MiniInterNF";
        Can_Rotate = true;
        APos = new Point(1, 2);
        QPos = new Point(5, 2);
    ...
    public MiniInterNF(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        MiniInterNF miniinternf = new MiniInterNF(this, i, j);
        miniinternf.NbRotation = NbRotation;
        miniinternf.updatePinsPosition();
        return miniinternf;
    }

    public boolean SimMouseDown()
    {
        MiniInterNFClosed = !MiniInterNFClosed;
        return true;
    }
