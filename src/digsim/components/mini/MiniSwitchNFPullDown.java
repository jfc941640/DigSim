...
public class MiniSwitchNFPullDown extends ElectronicComponent
{

    public MiniSwitchNFPullDown(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "Contact NF (R) avec resistance de pull-down";
        ClassName = "MiniSwitchNFPullDown";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public MiniSwitchNFPullDown(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        MiniSwitchNFPullDown miniswitchnfpulldown = new MiniSwitchNFPullDown(this, i, j);
        return miniswitchnfpulldown;
    }
