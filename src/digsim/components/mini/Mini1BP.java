...
public class Mini1BP extends ElectronicComponent
{

    public Mini1BP(Pin apin[][], int i, int j)
    {
        super(i, j, 2, 2, 1, 0, 3, 2, 0, 1);
        ComponentName = "Poussoir";
        ClassName = "Mini1BP";
        Can_Rotate = false;
    ...
    public Mini1BP(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Mini1BP mini1bp = new Mini1BP(this, i, j);
        return mini1bp;
    }
