...
public class MiniInterNO extends ElectronicComponent
{

    public MiniInterNO(Pin apin[][], int i, int j)
    {
        super(i, j, 10, 5, 2, 1, 2, 2, 0, 0);
        MiniInterNOClosed = true;
        ALevel = -1;
        QLevel = -1;
        ComponentName = "Inter NO (normalement ouvert - contact T)";
        ClassName = "MiniInterNO";
        Can_Rotate = true;
        APos = new Point(1, 2);
        QPos = new Point(5, 2);
    ...
    public MiniInterNO(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        MiniInterNO miniinterno = new MiniInterNO(this, i, j);
        miniinterno.NbRotation = NbRotation;
        miniinterno.updatePinsPosition();
        return miniinterno;
    }

    public boolean SimMouseDown()
    {
        MiniInterNOClosed = !MiniInterNOClosed;
        return true;
    }
