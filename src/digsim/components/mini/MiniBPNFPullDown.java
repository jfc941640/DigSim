...
public class MiniBPNFPullDown extends ElectronicComponent
{

    public MiniBPNFPullDown(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "BP NF (R) avec resistance de pull-down";
        ClassName = "MiniBPNFPullDown";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public MiniBPNFPullDown(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        MiniBPNFPullDown minibpnfpulldown = new MiniBPNFPullDown(this, i, j);
        return minibpnfpulldown;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        if(!OUT)
        {
            DrawWithOffset.strokeLine(g,(l + 2) * k, (i1 + 3) * k, (l + 3) * k + 4, (i1 + 3) * k);
            DrawWithOffset.strokeLine(g,(l + 2) * k, (i1 + 3) * k - 4, (l + 2) * k, (i1 + 4) * k - 4);
            DrawWithOffset.strokeLine(g,(l + 2) * k, (i1 + 3) * k - 4, (l + 2) * k + 2, (i1 + 3) * k - 6);
            DrawWithOffset.strokeLine(g,(l + 2) * k, (i1 + 4) * k - 4, (l + 2) * k + 2, (i1 + 4) * k - 2);
        } else
        {
        ...
        if(!OUT)
        {
            DrawWithOffset.strokeLine(g,(l + 4) * k + 1, (i1 + 2) * k, (l + 3) * k + 1, (i1 + 4) * k);
            DrawWithOffset.strokeLine(g,(l + 4) * k, (i1 + 2) * k, (l + 3) * k, (i1 + 4) * k);
        } else
        {
