...
public class MiniBPNOPullUp extends ElectronicComponent
{

    public MiniBPNOPullUp(Pin apin[][], int i, int j)
    {
        ...
        ComponentName = "BP NO (T) avec resistance de pull-up";
        ClassName = "MiniBPNOPullUp";
        Can_Rotate = true;
        RegisterPins(apin, i, j);
    }

    public MiniBPNOPullUp(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        MiniBPNOPullUp minibpnopullup = new MiniBPNOPullUp(this, i, j);
        return minibpnopullup;
    }
