...
public class SwitchT extends ElectronicComponent
{

    public SwitchT(Pin apin[][], int i, int j)
    {
        ...
        BLevel = -1;
        QLevel = -1;
        ComponentName = "Contact T (type travail)";
        ClassName = "SwitchT";
        Can_Rotate = true;
        APos = new Point(1, 2);
        BPos = new Point(1, 4);
    ...
    public SwitchT(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        SwitchT switcht = new SwitchT(this, i, j);
        switcht.NbRotation = NbRotation;
        switcht.updatePinsPosition();
        return switcht;
    }
