...
public class Inverter extends LogicPort
{

    public Inverter(Pin apin[][], int i, int j)
    {
        super(1, i, j, 3);
        ComponentName = "Porte_''Non''_(inverseur_complementation)";
        ClassName = "Inverter";
        Can_Rotate = true;
    ...
    public Inverter(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Inverter inverter = new Inverter(this, i, j);
        return inverter;
    }
