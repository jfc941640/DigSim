...
public class Oscillateur500ms extends ElectronicComponent
{

    public Oscillateur500ms(Pin apin[][], int i, int j)
    {
        super(i, j, 8, 6, 1, 1, 4, 4, 0, 1);
        ComponentName = "Horloge 500ms";
        ClassName = "Oscillateur500ms";
        Can_Rotate = true;
    ...
    public Oscillateur500ms(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        Oscillateur500ms oscillateur500ms = new Oscillateur500ms(this, i, j);
        return oscillateur500ms;
    }
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        Temps = Math.round((int)(Millis / 250D)) % 2;
        g.setFill(MyColor.black);
        DrawWithOffset.fillText(g,"500 ms", (l + 2) * k - 6, (i1 + 3) * k + 5);
    }
