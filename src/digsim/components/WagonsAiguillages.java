...
public class WagonsAiguillages extends IntegratedCircuit
{

    public WagonsAiguillages(Pin apin[][], int i, int j)
    {
        super(i, j, 58, 18, 2, 2, 54, 14, 7, 11);
        SwitchClosed = false;
        ...
        IPin[5] = new InputPin("Ag", 19, 18, 0, -2, 0, 0, 0);
        IPin[6] = new InputPin("Ad", 39, 18, 0, -2, 0, 0, 0);
        ...
        ComponentName = "Wagonnets et aiguillages";
        ClassName = "WagonsAiguillages";
        Can_Rotate = false;
        RegisterPins(apin, i, j);
    }

    public WagonsAiguillages(ElectronicComponent electroniccomponent, int i, int j)
    {
    ...
    {
        WagonsAiguillages wagonsaiguillages = new WagonsAiguillages(this, i, j);
        return wagonsaiguillages;
    }
    ...
    public void SimulateLogic()
    {
        ...
        if(CtrXx <= 2 && SgnXg == 1 || CtrYx <= 2 && SgnYg == 1)
            A = 5;
        else
            A = 0;
        if(CtrXx >= 22 && CtrXx <= 26 && SgnXg == 1 || CtrYx >= 22 && CtrYx <= 26 && SgnYg == 1)
            B = 5;
        else
            B = 0;
        if(CtrXx >= 70 && CtrXx <= 74 && SgnXd == 1 || CtrYx >= 70 && CtrYx <= 74 && SgnYd == 1)
            C = 5;
        else
            C = 0;
        if(CtrXx >= 94 && SgnXd == 1 || CtrYx >= 94 && SgnYd == 1)
            D = 5;
        else
            D = 0;
        if(CtrXx <= 2 && SgnXg == -1 || CtrYx <= 2 && SgnYg == -1)
        ...
        if(CtrXx >= 56 && CtrXx <= 60 || CtrYx >= 56 && CtrYx <= 60)
            ...
            K = 0;
        if((CtrXx >= 25 && CtrXx <= 71 && CtrYx >= 25 && CtrYx <= 71 || Math.abs(CtrXy - CtrYy) < 5) && CtrXx - CtrYx <= 3 && CtrYx - CtrXx <= 3)
            Coll = true;
        else
            Coll = false;
        if((A == 5 && SgnXg == 1 || E == 5 && SgnXg == -1) && CtrXx <= 2 && IPin[2].getOldLevel() == 0 && Xd == 5)
        {
            WaitX = Tmin + Math.round((int)((double)Tmax * Math.random()));
            PoseX = 0;
        } else
        if((D == 5 && SgnXd == 1 || H == 5 && SgnXd == -1) && CtrXx >= 94 && IPin[1].getOldLevel() == 0 && Xg == 5)
        {
            WaitX = Tmin + Math.round((int)((double)Tmax * Math.random()));
            PoseX = 0;
        }
        if((A == 5 && SgnYg == 1 || E == 5 && SgnYg == -1) && CtrYx <= 2 && IPin[4].getOldLevel() == 0 && Yd == 5)
        {
            WaitY = Tmin + Math.round((int)((double)Tmax * Math.random()));
            PoseY = 0;
        } else
        if((D == 5 && SgnYd == 1 || H == 5 && SgnYd == -1) && CtrYx >= 94 && IPin[3].getOldLevel() == 0 && Yg == 5)
        {
            WaitY = Tmin + Math.round((int)((double)Tmax * Math.random()));
            PoseY = 0;
        }
        if(IPin[2].getOldLevel() == 5 && Xd == 0 && (D == 5 && SgnXd == 1 || H == 5 && SgnXd == -1) && CtrXx >= 94 || IPin[1].getOldLevel() == 5 && Xg == 0 && (A == 5 && SgnXg == 1 || E == 5 && SgnXg == -1) && CtrXx <= 2)
            PoseX = 0;
        if(IPin[4].getOldLevel() == 5 && Yd == 0 && (D == 5 && SgnYd == 1 || H == 5 && SgnYd == -1) && CtrYx >= 94 || IPin[3].getOldLevel() == 5 && Yg == 0 && (A == 5 && SgnYg == 1 || E == 5 && SgnYg == -1) && CtrYx <= 2)
            PoseY = 0;
        ...
        OPin[9].setLevel(J);
        OPin[10].setLevel(K);
        if(CtrXx < 0 || CtrXx > 96 || CtrYx < 0 || CtrYx > 96)
            gOver = true;
        if(CtrXx > 96)
            CtrXx = 96;
        if(CtrXx < 0)
    ...
    public void draw(GraphicsContext g, int i, int j, int k)
    {
        ...
        DrawWithOffset.strokeLine(g,(l + 21) * k, (i1 + 9) * k - 1, (l + 22) * k, (i1 + 9) * k - 1);
        DrawWithOffset.strokeLine(g,(l + 21) * k, (i1 + 9) * k, (l + 22) * k, (i1 + 9) * k);
        DrawWithOffset.strokeLine(g,(l + 21) * k, (i1 + 9) * k + 1, (l + 22) * k, (i1 + 9) * k + 1);
        DrawWithOffset.strokeLine(g,(l + 36) * k, (i1 + 9) * k - 1, (l + 37) * k, (i1 + 9) * k - 1);
        DrawWithOffset.strokeLine(g,(l + 36) * k, (i1 + 9) * k, (l + 37) * k, (i1 + 9) * k);
        DrawWithOffset.strokeLine(g,(l + 36) * k, (i1 + 9) * k + 1, (l + 37) * k, (i1 + 9) * k + 1);
        if(Ag == 0)
        {
            DrawWithOffset.strokeLine(g,(l + 19) * k, (i1 + 9) * k + 3, (l + 21) * k, (i1 + 9) * k - 1);
            DrawWithOffset.strokeLine(g,(l + 19) * k, (i1 + 9) * k + 4, (l + 21) * k, (i1 + 9) * k);
            DrawWithOffset.strokeLine(g,(l + 19) * k, (i1 + 9) * k + 5, (l + 21) * k, (i1 + 9) * k + 1);
        } else
        {
            DrawWithOffset.strokeLine(g,(l + 19) * k, (i1 + 9) * k - 5, (l + 21) * k, (i1 + 9) * k - 1);
            DrawWithOffset.strokeLine(g,(l + 19) * k, (i1 + 9) * k - 4, (l + 21) * k, (i1 + 9) * k);
        ...
        if(Ad == 0)
        {
            DrawWithOffset.strokeLine(g,(l + 37) * k, (i1 + 9) * k - 1, (l + 39) * k, (i1 + 9) * k + 3);
            DrawWithOffset.strokeLine(g,(l + 37) * k, (i1 + 9) * k, (l + 39) * k, (i1 + 9) * k + 4);
            DrawWithOffset.strokeLine(g,(l + 37) * k, (i1 + 9) * k + 1, (l + 39) * k, (i1 + 9) * k + 5);
        } else
        {
            DrawWithOffset.strokeLine(g,(l + 37) * k, (i1 + 9) * k - 1, (l + 39) * k, (i1 + 9) * k - 5);
            DrawWithOffset.strokeLine(g,(l + 37) * k, (i1 + 9) * k, (l + 39) * k, (i1 + 9) * k - 4);
        ...
        if(A == 5 && SgnXg == 1 && WaitX > 0)
            DrawWithOffset.fillText(g,Integer.toString(WaitX), (l + 2) * k + 4, (i1 + 5) * k + 5);
        if(E == 5 && SgnXg == -1 && WaitX > 0)
            DrawWithOffset.fillText(g,Integer.toString(WaitX), (l + 2) * k + 4, (i1 + 13) * k + 5);
        if(D == 5 && SgnXd == 1 && WaitX > 0)
            DrawWithOffset.fillText(g,Integer.toString(WaitX), (l + 54) * k + 4, (i1 + 5) * k + 5);
        if(H == 5 && SgnXd == -1 && WaitX > 0)
            DrawWithOffset.fillText(g,Integer.toString(WaitX), (l + 54) * k + 4, (i1 + 13) * k + 5);
        g.setFill(MyColor.blue);
        DrawWithOffset.fillText(g,"Y=" + Integer.toString(CtrYx), (l + 45) * k, (i1 + 15) * k + 5);
        if(A == 5 && SgnYg == 1 && WaitY > 0)
            DrawWithOffset.fillText(g,Integer.toString(WaitY), (l + 2) * k + 4, (i1 + 5) * k + 5);
        if(E == 5 && SgnYg == -1 && WaitY > 0)
            DrawWithOffset.fillText(g,Integer.toString(WaitY), (l + 2) * k + 4, (i1 + 13) * k + 5);
        if(D == 5 && SgnYd == 1 && WaitY > 0)
            DrawWithOffset.fillText(g,Integer.toString(WaitY), (l + 54) * k + 4, (i1 + 5) * k + 5);
        if(H == 5 && SgnYd == -1 && WaitY > 0)
        ...
        if(CtrXx < 32)
        {
            if(SgnXg == 1)
                ...
                CtrXy = -(CtrXx - 32);
            g.setFill(MyColor.red);
            DrawWithOffset.fillRect(g,(l + 4) * k + 1 + 4 * CtrXx, (i1 + 8) * k + 1 + CtrXy, 2 * k - 2, 2 * k - 2);
            g.setStroke(MyColor.blue);
            DrawWithOffset.strokeRect(g,(l + 4) * k + 1 + 4 * CtrXx, (i1 + 8) * k + 1 + CtrXy, 2 * k - 2, 2 * k - 2);
            if(PoseX == 1 && !Coll)
            {
                g.setFill(MyColor.blue);
                DrawWithOffset.fillOval(g,((l + 5) * k - 3) + 4 * CtrXx, ((i1 + 9) * k - 3) + CtrXy, 1 * k, 1 * k);
                g.setStroke(MyColor.yellow);
                DrawWithOffset.strokeOval(g,((l + 5) * k - 4) + 4 * CtrXx, ((i1 + 9) * k - 4) + CtrXy, 1 * k, 1 * k);
            }
        } else
        ...
        if(CtrYx < 32)
        {
            if(SgnYg == 1)
                ...
                CtrYy = -(CtrYx - 32);
            g.setFill(MyColor.blue);
            DrawWithOffset.fillRect(g,(l + 4) * k + 1 + 4 * CtrYx, (i1 + 8) * k + 1 + CtrYy, 2 * k - 2, 2 * k - 2);
            g.setStroke(MyColor.red);
            DrawWithOffset.strokeRect(g,(l + 4) * k + 1 + 4 * CtrYx, (i1 + 8) * k + 1 + CtrYy, 2 * k - 2, 2 * k - 2);
            if(PoseY == 1 && !Coll)
            {
                g.setFill(MyColor.red);
                DrawWithOffset.fillOval(g,((l + 5) * k - 3) + 4 * CtrYx, ((i1 + 9) * k - 3) + CtrYy, 1 * k, 1 * k);
                g.setStroke(MyColor.yellow);
                DrawWithOffset.strokeOval(g,((l + 5) * k - 4) + 4 * CtrYx, ((i1 + 9) * k - 4) + CtrYy, 1 * k, 1 * k);
            }
        } else
